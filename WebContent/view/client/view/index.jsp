...
<body>
	<!-- Subiz -->
<script>!function(s,u,b,i,z){var o,t,r,y;s[i]||(s._sbzaccid=z,s[i]=function(){s[i].q.push(arguments)},s[i].q=[],s[i]("setAccount",z),r=["widget.subiz.net","storage.googleapis"+(t=".com"),"app.sbz.workers.dev",i+"a"+(o=function(k,t){var n=t<=6?5:o(k,t-1)+o(k,t-3);return k!==t?n:n.toString(32)})(20,20)+t,i+"b"+o(30,30)+t,i+"c"+o(40,40)+t],(y=function(k){var t,n;s._subiz_init_2094850928430||r[k]&&(t=u.createElement(b),n=u.getElementsByTagName(b)[0],t.async=1,t.src="https://"+r[k]+"/sbz/app.js?accid="+z,n.parentNode.insertBefore(t,n),setTimeout(y,2e3,k+1))})(0))}(window,document,"script","subiz","acqwrwlmbizdjvsbamqa");</script>
	<!-- End Subiz -->
					...
					<c:forEach items="${pwelcome }" var="p">
						...
						<li class="item">
							...
							<div class="product-img">
								<c:url value="/product/detail?id=${p.id}" var="addToCard"/>
								 <a
									href="${addToCard}"><img
				...
				<div class="col-md-4 md-margin-bottom-30">
					<div class="overflow-h">
						<a class="illustration-v3 illustration-img1"
							href="<c:url value="/product/category?cate_id=1"/>">
				...
				<div class="col-md-4 md-margin-bottom-30">
					<div class="overflow-h">
						<a class="illustration-v3 illustration-img2"
							href="<c:url value="/product/category?cate_id=2"/>">
							<span class="illustration-bg"> <span
								class="illustration-ads"> <span
									class="illustration-v3-category"> <span
				...
				<div class="col-md-4">
					<div class="overflow-h">
						<a class="illustration-v3 illustration-img3"
							href="<c:url value="/product/category?cate_id=3"/>">
							<span class="illustration-bg"> <span
								class="illustration-ads"> <span
									class="illustration-v3-category"> <span
			...
			<div class="row illustration-v2">
				...
				<c:forEach items="${pwelcome }" var="p">
					...
					<div class="col-md-3 col-sm-6 md-margin-bottom-30">
						<div class="product-img">
							<a
								href="<c:url value="/product/detail?id=${p.id}"/>"><img
								width="314" height="414" src="${imgUrl }" alt=""
								"
							alt=""></a> <a class="product-review"
								href="<c:url value="/product/detail?id=${p.id}"/>">Quick
								review</a> <a class="add-to-cart"
								href="<c:url value="/product/detail?id=${p.id}"/>"><i
							...
							<div class="overflow-h margin-bottom-5">
								<div class="pull-left">
									<h4 class="title-price">
										<a
											href="<c:url value="/product/detail?id=${p.id}"/>">${p.name }</a>
