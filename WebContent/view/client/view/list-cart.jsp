...
<body class="header-fixed">
	<div class="wrapper">
		...
		<div class="content-md margin-bottom-30">
			<div class="container">
				<form class="<c:url value="/shopping-cart"/>" action="#">
					<div>
								...
								<table class="table table-striped">
									...
									<tbody>
										<c:forEach items="${sessionScope.cart}" var="map">
											...
											<tr>
												...
												<td><a
													href="<c:url value="/member/cart/remove?pId=${map.value.product.id}"/>"><button
									...
									<tfoot>
										<tr>
										      ...
										      <td></td>
										      <td></td>
										      <td><a href="<c:url value="/member/order"/>" class="btn-u btn-u-sea-shop btn-block">Checkout</a></td>
									    </tr>
									</tfoot>
								</table>
							</div>
