							...
							<div id="collapseOne" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										...
										<form action="<c:url value="/product/seach"/>" method="get">
					...
					<div class="panel-group" id="accordion-v2">
						<div class="panel panel-default">
							...
							<div id="collapseTwo" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										<a href="<c:url value="/product/category?cate_id=1"/>" > MEN</a>
										<br>
										<a href="<c:url value="/product/category?cate_id=2"/>" > WOMAN</a>
										<br>
										<a href="<c:url value="/product/category?cate_id=3"/>" > CHILDREN</a>
									</ul>
								</div>
							</div>
						</div>
