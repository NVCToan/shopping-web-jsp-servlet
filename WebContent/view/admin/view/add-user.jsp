...
<c:url value="/api-admin-new" var="APIurl"></c:url>
<c:url value="/admin/user/list" var="HOMEurl"></c:url>
<c:url value="/admin/user/add" var="ADDurl"></c:url>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										...
										<form id="formSubmit" role="form"  enctype="multipart/form-data">
											...
											<div class="form-group">
												<label>Role</label>
												<div class="checkbox">
													<label> <input type="radio" value="1" name="roleId"/>Admin
													</label>
													<br>
													<label> <input type="radio" value="2" name="roleId" />Client
													</label>
												</div>
												
											</div>
											<!-- <div class="form-group">
												<label>Avatar</label> <input type="file" id="avatar" name="avatar" />
											</div> -->
...
<!-- Sử dụng ajax và api để add dữ liệu vào database -->
<script>
